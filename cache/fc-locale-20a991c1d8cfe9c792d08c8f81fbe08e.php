...
',
  'emails.orcidCollectAuthorId.description' => 'Ce modèle de courriel est utilisé pour récupérer les identifiants ORCID des auteurs-es.',
...
{$principalContactSignature}<br/>
',
  'emails.orcidRequestAuthorAuthorization.description' => 'Ce modèle de courriel est utilisé pour demander aux auteurs-es l\'accès à leur dossier ORCID.',
);